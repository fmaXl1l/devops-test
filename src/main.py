...
async def devops_endpoint(
    ...
    api_key: str = Header(
        ...
        description="API Key: 2f5ae96c-b558-4c7b-a590-a501ae1c3f6c",
    ),
    jwt_token: str = Header(
        ..., alias="X-JWT-KWY", description="JWT token obtained from /generate-token"
    ),
):
    """
...
@app.post(
    ...
    responses={
        200: {
            ...
            "content": {
                "application/json": {
                    "example": {"jwt": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..."}
                }
            },
        }
    },
...
async def health_check():
    ...
    """
    return {"status": "healthy", "service": "DevOps Microservice", "version": "1.0.0"}
